"""Azure Databricks pricing backend."""
...
class AzureDatabricksBackend:
    ...
    def estimate(
        ...
        *,
        ...
        spec = self.resolve_instance(instance_type or "Standard_DS3_v2", region)
        if spec is None:
        ...
        dbu_rate = DBU_RATES.get(sku or "ALL_PURPOSE", 0.55)
        if photon_enabled:
...
register_backend("azure-databricks", AzureDatabricksBackend)
